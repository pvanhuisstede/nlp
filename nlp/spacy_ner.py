...
# %% auto 0
__all__ = ['ner_lst', 'train_data', 'ner', 'pipe_exceptions', 'unaffected_pipes', 'text', 'doc', 'entities', 'output_dir',
           'nlp_updated', 'nlp', 'ruler', 'patterns', 'corpus', 'TRAIN_DATA', 'LABEL', 'optimizer', 'move_names',
